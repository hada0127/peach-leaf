...
PeachLeaf를 처음 다운로드하고 열 때, macOS에서 앱이 "손상되었습니다" 또는 "신뢰할 수 없는 개발자"라는 보안 경고를 표시할 수 있습니다. 이는 Mac App Store 외부에서 배포되는 앱에서 나타나는 정상적인 현상입니다.
...
**방법 3: 시스템 설정**
1. 시스템 설정 → 개인 정보 보호 및 보안으로 이동
2. 아래로 스크롤하여 "PeachLeaf가 차단되었습니다" 찾기
3. "확인 없이 열기" 클릭
